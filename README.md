...
![icons](https://go-skill-icons.vercel.app/api/icons?i=c,cpp,python,javascript,linux,git,cmake,docker,mysql,django,fastapi,numpy,pandas,scikitlearn,pytorch,tensorflow,matplotlib,seaborn,jupyter,neovim,arch,lightroom&theme=dark)
